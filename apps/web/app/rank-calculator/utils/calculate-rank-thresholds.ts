...
export const calculateRankThresholds = (
  ...
  return {
    ...
    Admin: {
      Captain: 0,
      General: standardRankPoints.Achiever,
      Colonel: standardRankPoints.Raider,
      Brigadier: standardRankPoints.Gamer,
      Admiral: standardRankPoints.Adventurer,
      Marshal: standardRankPoints.Bandosian,
    },
